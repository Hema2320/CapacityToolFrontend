                      ...
                      return (
                        <>
                          <tr>
                            ...
                            <td>{element.spentTime}</td>
                            {/* <td>{element.gender == "Male" ? "M" : "F"}</td> */}
                            <td className='d-flex align-items-center'>
                              <Dropdown className='text-center'>
                                <Dropdown.Toggle className='dropdown_btn' id="dropdown-basic">
                                  <Badge bg={element.status == "Progress" ? "primary" : "danger"}>
                                    {element.status} <i class="fa-solid fa-angle-down"></i>
                                  </Badge>
                                </Dropdown.Toggle>
                                <Dropdown.Menu>
                                  <Dropdown.Item onClick={() => handleChange(element._id, "Progress")}>Progress</Dropdown.Item>
                                  <Dropdown.Item onClick={() => handleChange(element._id, "Inprogress")}>Inprogress</Dropdown.Item>
                                  <Dropdown.Item onClick={() => handleChange(element._id, "Complete")}>Complete</Dropdown.Item>
                                  <Dropdown.Item onClick={() => handleChange(element._id, "Incomplete")}>Incomplete</Dropdown.Item>
                                </Dropdown.Menu>
                              </Dropdown>
                            </td>
                            <td>
